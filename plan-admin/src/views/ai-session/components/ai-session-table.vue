...
const aiSessionTableHelper = inject(
  'aiSessionTableHelper',
  useTableHelper(api.aiSessionForAdminController.query, api.aiSessionForAdminController, {}),
)
const {
  loadTableData,
  handleSortChange,
...
const handleDelete = (ids: string[]) => {
  ElMessageBox.confirm('此操作将删除数据且无法恢复, 是否继续?', '警告', {
    ...
    api.aiSessionForAdminController.delete({ body: ids }).then((res) => {
